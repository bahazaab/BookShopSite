            ...
            <div>
                <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                    ...
                    @elseif (request('search'))
                        <a href="{{ $paginator->previousPageUrl() . '&search=' . request('search') }}" rel="prev"
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span
                                            class="relative inline-flex items-center px-4 py-2 -ml-px text-xl font-bold text-gray-500  bg-white border border-gray-300 cursor-default leading-5 dark:bg-black dark:border-gray-600">{{ $page }}</span>
                                    </span>
                                @elseif (request('search'))
                    ...
                    @if ($paginator->hasMorePages())
                        @if (request('search'))
                            <a href="{{ $paginator->nextPageUrl() . '&search=' . request('search') }}" rel="next"
