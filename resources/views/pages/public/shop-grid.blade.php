                                    ...
                                    <div class="col-lg-4">
                                        <div class="product__discount__item">
                                            <div class="product__discount__item__pic set-bg"
                                                data-setbg="{{ $book->image_url }}">
                                                <div class="product__discount__percent">-{{ $book->discount }}%</div>
                                            ...
                                            <div class="product__discount__item__text">
                                                ...
                                                <div class="product__item__price">
                                                    ${{ round($book->price * (1 - $book->discount * 0.01), 2) }}
                        ...
                        @foreach ($books as $book)
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product__item">
                                    <div class="product__item__pic set-bg" data-setbg="{{ $book->image_url }}">
                                        <ul class="product__item__pic__hover">
                                            <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                            <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                            <li>
                                                <a href="{{ route('public.details',$book) }}">
